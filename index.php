  ...
  <div class="container">
    <div class="row align-items-center ">
      ...
      <div class="col-md-6 ml-auto align-self-end">
        <img src="wp-content/themes/artista/images/kid_transparent.png" alt="Image" class="img-fluid">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-6 mb-5 mb-md-0">
      <img src="wp-content/themes/artista/images/img_1.jpg" alt="Image" class="img-fluid">
    </div>
  ...
  <div class="row">
    <div class="col-lg-4 mb-4 mb-lg-0">
      <div class="package text-center bg-white">
        <span class="img-wrap"><img src="wp-content/themes/artista/images/flaticon/svg/001-jigsaw.svg" alt="Image" class="img-fluid"></span>
    ...
    <div class="col-lg-4 mb-4 mb-lg-0">
      <div class="package text-center bg-white">
        <span class="img-wrap"><img src="wp-content/themes/artista/images/flaticon/svg/002-target.svg" alt="Image" class="img-fluid"></span>
    ...
    <div class="col-lg-4 mb-4 mb-lg-0">
      <div class="package text-center bg-white">
        <span class="img-wrap"><img src="wp-content/themes/artista/images/flaticon/svg/003-mission.svg" alt="Image" class="img-fluid"></span>
        ...
        <div class="owl-carousel nonloop-block-13">
          <div class="testimonial-3 d-flex">
            <div class="vcard-wrap mr-5">
              <img src="wp-content/themes/artista/images/person_1.jpg" alt="Image" class="vcard img-fluid">
            </div>
            <div class="text">
              <h3>Jeff Woodland</h3>
          ...
          <div class="testimonial-3 d-flex">
            <div class="vcard-wrap mr-5">
              <img src="wp-content/themes/artista/images/person_3.jpg" alt="Image" class="vcard img-fluid">
            </div>
            <div class="text">
              <h3>Jeff Woodland</h3>
              <p class="position">Partner</p>
          ...
          <div class="testimonial-3 d-flex">
            <div class="vcard-wrap mr-5">
              <img src="wp-content/themes/artista/images/person_2.jpg" alt="Image" class="vcard img-fluid">
            </div>
            <div class="text">
              <h3>Jeff Woodland</h3>
              <p class="position">Partner</p>
